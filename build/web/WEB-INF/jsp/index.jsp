...
<%@include file="vista/cabecera.jsp" %>
<html>
    <head>
        ...
        <title>Opcion Inscripcion</title>
    </head>
        ...
        <div class="container">
            <div class="row">
                <div class="panel panel-primary">
                    <div class="panel-heading"><p>Este es el inicio</p></div>
                    <div class="panel-body">
                    <i>Seleccione una opción: </i>
                    <ul>
                        <li><a href="formJstl.htm" class="btn btn-link"> Ingresar Datos </a></li>
                        <li>Opcion Datos</li>
